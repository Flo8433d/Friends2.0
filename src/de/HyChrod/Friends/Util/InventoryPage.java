...
public class InventoryPage {
	...
	public void open() {
		...
		inv.setItem(FileManager.ConfigCfg.getInt("Friends.GUI.RequestsItem.InventorySlot")-1, ItemStacks.MAIN_REQUESTS(pu.getRequests().size()));
		inv.setItem(FileManager.ConfigCfg.getInt("Friends.GUI.BlockedItem.InventorySlot")-1, ItemStacks.MAIN_BLOCKED(pu.getBlocked().size()));
