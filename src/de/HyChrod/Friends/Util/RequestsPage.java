...
public class RequestsPage {
	...
	public void open() {
		Inventory inv = Bukkit.createInventory(null, cfg.getInt("Friends.GUI.RequestsInv.InventorySize"), 
				ChatColor.translateAlternateColorCodes('&', cfg.getString("Friends.GUI.RequestsInv.Title")));
		
		for(String placeholder : cfg.getStringList("Friends.GUI.RequestsInv.PlaceholderItem.InventorySlots")) {
