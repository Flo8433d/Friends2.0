...
public class RequestsPage {
	...
	public void open() {
		Inventory inv = Bukkit.createInventory(null, FileManager.ConfigCfg.getInt("Friends.GUI.RequestsInv.InventorySize"), 
				ChatColor.translateAlternateColorCodes('&', FileManager.ConfigCfg.getString("Friends.GUI.RequestsInv.Title")));
		
		for(String placeholder : FileManager.ConfigCfg.getStringList("Friends.GUI.RequestsInv.PlaceholderItem.InventorySlots")) {
